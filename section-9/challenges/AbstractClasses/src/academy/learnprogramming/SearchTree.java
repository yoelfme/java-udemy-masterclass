...
public class SearchTree implements NodeList {
    ...
    public boolean addItem(ListItem newItem) {
        ...
        // we can't actually get here, but Java complains if there's no current
        return false;
    }
    ...
    private void performRemoval(ListItem item, ListItem parent) {
        ...
        if (item.next() == null) {
            ...
            // from the right sub-tree, find the smallest value (i.i., the leftmost).
